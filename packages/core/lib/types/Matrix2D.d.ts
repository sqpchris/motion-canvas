...
export type PossibleMatrix2D = Matrix2D | [number, number, number, number, number, number] | [PossibleVector2, PossibleVector2, PossibleVector2] | undefined;
/**
...
export declare class Matrix2D implements Type {
    ...
    static fromTranslation(translation: PossibleVector2<number>): Matrix2D;
    static fromScaling(scale: PossibleVector2<number>): Matrix2D;
    get x(): Vector2;
    get y(): Vector2;
    get scaleX(): number;
    ...
    set scaling(value: PossibleVector2<number>);
    get scaling(): Vector2;
    /**
    ...
    constructor(x: PossibleVector2<number>, y: PossibleVector2<number>, z: PossibleVector2<number>);
